...
def ctf_optimize_ratio_similarity(leadfield, template, mask, alpha, reg=0.000001):
    """
    Optimize a linear combination of similarity with a template CTF and within/outside CTF ratio
